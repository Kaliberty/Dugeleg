...
show_camera_feed = False  # Set this to False if you don't want to display the camera feed
...
def control_light_based_on_time():
    global LightLevel, PWM_Light, Transistor_Type
    ...
    if Transistor_Type == "NPN":
        if cTime < Sunrise or cTime > Sunset:
            LightLevel = 90
        else:
            LightLevel = 50
    elif Transistor_Type == "PNP":
